...
void R_Config_ADCA0_Create(void)
{
    ...
    ADCA0.DGCTL0.UINT32 = _ADC_SELF_DIAG_VOLTAGE_LEVEL_6;
    ADCA0.DGCTL1.UINT32 |= _ADC_SELF_DIAG_CH11_SEL_ANI11;
    ADCA0.DGCTL1.UINT32 |= _ADC_SELF_DIAG_CH12_SEL_ANI12;
    ADCA0.DGCTL1.UINT32 |= _ADC_SELF_DIAG_CH13_SEL_ANI13;
    ADCA0.DGCTL1.UINT32 |= _ADC_SELF_DIAG_CH14_SEL_ANI14;
    ADCA0.DGCTL1.UINT32 |= _ADC_SELF_DIAG_CH15_SEL_ANI15;
    ...
    ADCA0.SGCR2.UINT32 = _ADC_SG_SCAN_MODE_MULTICYCLE | _ADC_SG_SCAN_END_INT_ENABLE | _ADC_SG_CHANNEL_REPEAT_TIME_1;
    ADCA0.SGVCSP2.UINT32 = _ADC0_SG2_START_POINTER;
    ADCA0.SGVCEP2.UINT32 = _ADC0_SG2_END_POINTER;
    ADCA0.SGMCYCR2.UINT32 = _ADC_SG_MULTICYCLE_NUMBER_1;
    /* Set ADC0 scan group trigger enable */
    ADCA0.SGCR1.UINT32 |= _ADC_SG_HW_TRIGGER_DISABLE;
    ADCA0.SGCR2.UINT32 |= _ADC_SG_HW_TRIGGER_DISABLE;
...
/***********************************************************************************************************************
* Function Name: R_Config_ADCA0_ScanGroup2_Start
* Description  : This function enables ADC0 scan group 2 end interrupt.
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
void R_Config_ADCA0_ScanGroup2_Start(void)
{
    /* Clear ADC0 SG2 end interrupt (INTADCA0I1) request and enable operation */
    INTC1.ICADCA0I1.BIT.RFADCA0I1 = _INT_REQUEST_NOT_OCCUR;
    INTC1.ICADCA0I1.BIT.MKADCA0I1 = _INT_PROCESSING_ENABLED;
}

/***********************************************************************************************************************
* Function Name: R_Config_ADCA0_ScanGroup2_OperationOn
* Description  : This function starts ADC0 scan group 2 conversion.
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
void R_Config_ADCA0_ScanGroup2_OperationOn(void)
{
    /* Enable ADC0 SG2 operation */
    ADCA0.SGSTCR2.UINT32 = _ADC_START;
}

/***********************************************************************************************************************
* Function Name: R_Config_ADCA0_ScanGroup2_OperationOff
* Description  : This function stops ADC0 scan group 2 conversion.
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
void R_Config_ADCA0_ScanGroup2_OperationOff(void)
{
    /* Disable ADC0 SG2 operation */
    ADCA0.SGSTPCR2.UINT32 = _ADC_STOP;
}

/***********************************************************************************************************************
* Function Name: R_Config_ADCA0_ScanGroup2_GetResult
* Description  : This function gets A/D conversion result for ADC0 scan group 2.
* Arguments    : buffer -
*                    buffer pointer
*                buffer_size -
*                    the size of buffer
...
*                    MD_OK or MD_ARGERROR
***********************************************************************************************************************/
MD_STATUS R_Config_ADCA0_ScanGroup2_GetResult(uint16_t * const buffer, uint8_t buffer_size)
{
    uint8_t start_pointer;
    uint8_t end_pointer;
    uint8_t count_num;
    ...
    start_pointer = (uint8_t)ADCA0.SGVCSP2.UINT32;
    end_pointer = (uint8_t)ADCA0.SGVCEP2.UINT32;
    count_num = (end_pointer - start_pointer) + 1U;
    if (buffer_size < count_num)
    {
        return MD_ARGERROR;
